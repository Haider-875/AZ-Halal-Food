...
<section class="position-relative overflow-hidden pt-5 pb-5" style="padding-top: 140px !important;">
    <div class="position-absolute top-0 start-0 w-100 h-100" style="z-index: 1;">
        <img src="{{ asset('images/heroes/hero-about.webp') }}" alt="Halal meat preparation" class="w-100 h-100 object-fit-cover" fetchpriority="high" loading="eager" decoding="async" style="filter: brightness(0.2) saturate(0.7);">
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-duration="750">
                <div class="position-relative">
                    <img src="{{ asset('images/heroes/about-craft.webp') }}" alt="Fresh halal meat cuts" class="w-100 object-fit-cover shadow-lg" style="height: 440px; border: 1px solid rgba(212,175,55,0.25); filter: brightness(0.75) saturate(0.85);" loading="lazy" decoding="async">
